...
function generateAverage(features: CompatResult[]) {
  ...
  for (const feature of features) {
    ...
    if (feature.category !== undefined) {
      ...
      firstBrowser[year][feature.stableStats.first.browser][
        feature.category
      ].total += feature.stableStats.ageInDays;
      firstBrowser[year][feature.stableStats.first.browser][feature.category]
        .featureCount++;
      lastBrowser[year][feature.stableStats.last.browser][
        feature.category
      ].total += feature.stableStats.ageInDays;
      lastBrowser[year][feature.stableStats.last.browser][feature.category]
        .featureCount++;
    }
  }
